...
data class Wallet(
    ...
    val walletEquity: Double? = null,
    val currentValue: Double? = null,
    val activePnl: Double? = null,
    val usdtAvailable: Double? = null,
    val usdtValueInr: Double? = null,
    val estTotalFutures: Double? = null,
    val futuresWalletBalance: Double? = null,
    val source: String = "",
)
...
data class Position(
    ...
    val marginInr: Double? = null,
    val sizeInr: Double? = null,
